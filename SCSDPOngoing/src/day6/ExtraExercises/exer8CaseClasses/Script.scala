...
object Script {
  ...
  def main (args: Array[String]):Unit = {
    ...
    val director1 = Director("George","Lucas",1946)
    
    val director2 = Director("Spieldberg","Stephen",1950)
    
    println(director1.name())
    
    val movie1 = Film ("Star Wars", 1979, 10.0, director1)
    ...
    val director3 = Director("Ale","Cane",1975)
    println(director3.yearOfBirth)
